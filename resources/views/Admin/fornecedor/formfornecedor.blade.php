        ...
        <br>
          <div class="row">
              ...
              <div class="mb-3">
                ...
                <input type="text" name="nome" id="disabledTextInput" class="form-control" placeholder="Disabled input">
              </div>
            </div>
            <div class="col">
              <div class="mb-3">
                <label for="disabledTextInput" class="form-label">Razão Social</label>
                <input type="text" name="nome_r" id="disabledTextInput" class="form-control" placeholder="Disabled input">
              </div>
            </div>
        </div>
             <br> <br>
     <div class="row">
           <div class="col-4">
            <div class="mb-3">
              ...
              <input type="text" id="disabledTextInput" name="cnpj" class="form-control" placeholder="Disabled input">
            </div>
           </div>
            <div class="col">
              <div class="mb-3">
                <label for="disabledTextInput" class="form-label">Incrição estadual</label>
                <input type="text" id="disabledTextInput" name="inscri_esta" class="form-control" placeholder="Disabled input">
              </div>
            </div>
            <div class="col">
              </div>
    ...
    <div class="card-body">
        <div class="row">
           <div class="col-4">
            <div class="mb-3">
              <label for="disabledTextInput" class="form-label">nome</label>
              <input type="text" name="nome_contato"   id="disabledTextInput" class="form-control" placeholder="Disabled input">
            </div>
           </div>
            <div class="col">
              <div class="mb-3">
                <label for="disabledTextInput" class="form-label">Telefone</label>
                <input type="text" name="telefone" id="disabledTextInput" class="form-control" placeholder="Disabled input">
              </div>
            </div>
            <div class="col">
              <div class="mb-3">
                <label for="disabledTextInput" class="form-label">Email</label>
                <input type="email" name="email" id="disabledTextInput" class="form-control" placeholder="Disabled input">
              </div>
            </div>
        </div>
          <div class="row">
           <div class="col-4">
            <div class="mb-3">
              ...
              <input type="text" name="cargo" id="disabledTextInput" class="form-control" placeholder="Disabled input">
            </div>
           </div>
            <div class="col">
              <div class="mb-3">
      ...
      <div class="row">
           <div class="col-2">
            <div class="mb-3">
              ...
              <input type="text"  name="cep" id="disabledTextInput" class="form-control" placeholder="Disabled input">
            </div>
           </div>
            <div class="col">
              <div class="mb-3">
                <label for="disabledTextInput" class="form-label">Rua</label>
                <input type="text" id="disabledTextInput" name="rua" class="form-control" placeholder="Disabled input">
              </div>
            </div>
            <div class="col-2">
              <div class="mb-3">
                <label for="disabledTextInput" class="form-label">Nnúmero</label>
                <input type="text" name="numero" id="disabledTextInput" class="form-control" placeholder="Disabled input">
              </div>
            </div>
            <div class="col">
              <div class="mb-3">
                <label for="disabledTextInput" class="form-label">bairro</label>
                <input type="text" id="disabledTextInput" name="bairro" class="form-control" placeholder="Disabled input">
              </div>
            </div>
        </div>
          <br>
          <div class="row">
           <div class="col">
            <div class="mb-3">
              ...
              <input type="text" id="disabledTextInput" name="cidade" class="form-control" placeholder="Disabled input">
            </div>
           </div>
           <div class="col">
            <div class="mb-3">
              <label for="disabledTextInput" class="form-label">Estado</label>
              <input type="text" id="disabledTextInput" name="estado" class="form-control" placeholder="Disabled input">
            </div>
           </div>
            <div class="col">
              <div class="mb-3">
                <label for="disabledTextInput" class="form-label">Proximidade</label>
                <input type="text" id="disabledTextInput" name="proximidade" class="form-control" placeholder="Disabled input">
              </div>
            </div>
            <div class="col">
              <div class="mb-3">
